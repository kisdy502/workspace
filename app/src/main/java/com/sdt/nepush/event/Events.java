...
public class Events {
    ...
    public static final String SYS_PUSH_MESSAGE = "sys_push_message";
    ...
    public static final String REPORT_CHAT_MESSAGE_FAILED_STATUS = "report_chat_message_failed_status";
